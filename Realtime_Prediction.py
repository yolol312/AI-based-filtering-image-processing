...
class FaceRecognizer:
    ...
    def recognize_faces(self, frame, frame_number, image_name, yolo_model, gender_model, age_model, color_model, clothes_model, tracker, output_dir):
        ...
        for track in tracker_outputs:
            ...
            color = predict_color(frame, color_model, bbox)
            clothes = predict_clothes(frame, clothes_model, bbox)
